...
const sampleAppointments: Record<
  string,
  Array<{ id: number; time: string; title: string; duration: string }>
> = {
  "2025-07-26": [
    { id: 1, time: "09:00", title: "Team Meeting", duration: "1 hour" },
    { id: 2, time: "14:30", title: "Doctor Appointment", duration: "30 min" },
  ],
  "2025-07-27": [
    { id: 3, time: "10:00", title: "Client Call", duration: "45 min" },
  ],
  "2025-07-28": [
    { id: 4, time: "16:00", title: "Gym Session", duration: "1.5 hours" },
    { id: 5, time: "19:00", title: "Dinner with Friends", duration: "2 hours" },
  ],
};
...
const Calendar: React.FC = () => {
  ...
  const getAppointmentsForDate = (date: Date) => {
    ...
    return sampleAppointments[dateKey] || [];
  };
      ...
      <>
        <div className="grid grid-cols-7 gap-2 mb-4">
          ...
          {days.map((day, i) => {
            ...
            const hasEvents = date ? hasAppointments(date) : false;
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${
                    hasEvents && !isToday && !isPastDay
                      ? "border-l-4 border-l-green-400"
                      : ""
                  }
                  ${
                    hasEvents && isPastDay ? "border-l-4 border-l-gray-300" : ""
                  }
                `}
              >
      ...
      <div className="grid grid-cols-7 gap-2 mb-4">
        ...
        {days.map((date, i) => {
          ...
          return (
            ...
            >
              <div
                className={`${hasEvents && !isToday ? "font-semibold" : ""}`}
              >
                {date.getDate()}
              </div>
              {hasEvents && (
                ...
                >
                  {getAppointmentsForDate(date).length} events
                </div>
              )}
            </div>
          );
