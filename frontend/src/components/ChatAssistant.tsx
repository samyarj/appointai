  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I can help you schedule events, add todos, or create categories. Just ask!",
      timestamp: new Date(),
    },
  ]);
            ...
            {messages.map(msg => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`text-[10px] block mt-1 opacity-70 ${msg.role === "user" ? "text-blue-100" : "text-gray-400"}`}
                  >
